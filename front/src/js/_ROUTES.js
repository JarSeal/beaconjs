...
import { checkRouteAccess } from './helpers/rightsAndAccess';
import { checkAccountVerification } from './helpers/utils';
...
export const _CONFIG = Object.assign({}, _conf, frontConfig, conf);
